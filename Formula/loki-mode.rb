class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.69.0/loki-mode-7.69.0.tar.gz"
  sha256 "dbddc7da7e501ce288423896512ad73d5541b2c918ff19f420b9742470408d29"
  license "BUSL-1.1"
