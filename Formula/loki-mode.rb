class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.54.0/loki-mode-7.54.0.tar.gz"
  sha256 "dddd4bcfe6a9697534708a3f0993274ec6a4d832157244081e35923eae09b732"
  license "BUSL-1.1"
