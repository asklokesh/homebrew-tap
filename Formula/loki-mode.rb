class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.4.0/loki-mode-8.4.0.tar.gz"
  sha256 "cd90ca0cc1841ce6a10264aa8801e651ca26ce54546faadd1d5ed54cefe2728c"
  license "BUSL-1.1"
