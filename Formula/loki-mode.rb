class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.17.0/loki-mode-9.17.0.tar.gz"
  sha256 "9adfabafe83561349371bc57529add3e4337e91c1e7a0125bb944bd18dfb910b"
  license "BUSL-1.1"
