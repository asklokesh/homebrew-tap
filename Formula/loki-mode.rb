class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.65.0/loki-mode-8.65.0.tar.gz"
  sha256 "7aa0b029121c8126b139189111733955d4cb3489f2ca4c5f1c11486e1ce0df51"
  license "BUSL-1.1"
