class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.90.2/loki-mode-7.90.2.tar.gz"
  sha256 "cb03af997276d6a1e83c1b587dcd314dde9047cd166c729487981846c3b653a5"
  license "BUSL-1.1"
