class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.38.0/loki-mode-7.38.0.tar.gz"
  sha256 "ffe4300992209fdca6cceef4c99aa7a330702b8cea559f199526dc1e5408c9f0"
  license "BUSL-1.1"
