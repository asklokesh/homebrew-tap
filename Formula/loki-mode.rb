class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.102.0/loki-mode-7.102.0.tar.gz"
  sha256 "5128568f098300e74118d30245c5d97cbc388458b839cb40bf13fa644d2ccc8f"
  license "BUSL-1.1"
