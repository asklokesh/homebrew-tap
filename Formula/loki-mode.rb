class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.93.0/loki-mode-8.93.0.tar.gz"
  sha256 "d9c61338287436fe1c01c82d90938d3580e61d1ccda57953f8f4df1e5911efd8"
  license "BUSL-1.1"
