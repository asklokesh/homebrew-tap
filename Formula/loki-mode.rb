class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.83.0/loki-mode-8.83.0.tar.gz"
  sha256 "af7d54994d0590bef917beee331622f56843cbcee691adc3b8377a16d5be4bd0"
  license "BUSL-1.1"
