class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.78.0/loki-mode-8.78.0.tar.gz"
  sha256 "25ff43fd42004cab0e1ea845ff740a12f7276941765dcfb9d4197a114b72f62b"
  license "BUSL-1.1"
