class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.121.4/loki-mode-7.121.4.tar.gz"
  sha256 "f300484823004a0ac91d69ca0145c7b133918637d215fbf3bb2753db76085f5a"
  license "BUSL-1.1"
