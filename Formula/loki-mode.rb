class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.6.1/loki-mode-8.6.1.tar.gz"
  sha256 "9199e1486785fac3b15189a9c23867649ff484c71be460db5c15184a22c20fbd"
  license "BUSL-1.1"
