class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.48.1/loki-mode-9.48.1.tar.gz"
  sha256 "f925abeb36039ce54627eae2dc947a1b39a9b88b4c6323f5e42dd10451debbe8"
  license "BUSL-1.1"
