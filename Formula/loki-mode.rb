class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.34.0/loki-mode-8.34.0.tar.gz"
  sha256 "649fdad9168f18950b7a6a0c5e4811d32a015c62bcf9e4af959e8c42183be8f1"
  license "BUSL-1.1"
