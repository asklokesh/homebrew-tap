class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.101.0/loki-mode-7.101.0.tar.gz"
  sha256 "f194b105ce269a8cc414a2b025455ff4753e6a286c45c05851937041f9306b03"
  license "BUSL-1.1"
