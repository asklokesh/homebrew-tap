class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.122.1/loki-mode-7.122.1.tar.gz"
  sha256 "f4dd8a52add0ba689515a20486e9e61a2257b19720340d25840b6aab04fea6bd"
  license "BUSL-1.1"
