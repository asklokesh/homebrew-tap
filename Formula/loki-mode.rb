class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.39.0/loki-mode-7.39.0.tar.gz"
  sha256 "d6b736858a66baf041b13c4479de11995a5eeb497707935520a2ca9a2d80828f"
  license "BUSL-1.1"
