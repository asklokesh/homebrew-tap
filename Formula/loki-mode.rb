class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.14.0/loki-mode-8.14.0.tar.gz"
  sha256 "f8f68347a2bf330fff77387be6e825f522624959ebdfb301fd099af832c8ff49"
  license "BUSL-1.1"
