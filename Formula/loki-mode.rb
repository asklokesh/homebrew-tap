class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.121.3/loki-mode-7.121.3.tar.gz"
  sha256 "cf82bfe08e89294d4ee706c5cd1f2a6a9b4482f671ede7fc040b7ac35d3d4f3b"
  license "BUSL-1.1"
