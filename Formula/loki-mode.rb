class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.3.0/loki-mode-8.3.0.tar.gz"
  sha256 "7eb5e3e9fbc0a608fcb9200cf7f956ac1d0ad88f593aedb80b0ead2c48db5796"
  license "BUSL-1.1"
