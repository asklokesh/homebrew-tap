class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.96.0/loki-mode-8.96.0.tar.gz"
  sha256 "df1e818617a773f00e63f7e184c080a7d85b0ab430cbda9634939aca7c3af3d7"
  license "BUSL-1.1"
