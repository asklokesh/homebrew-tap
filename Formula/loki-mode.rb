class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.17.1/loki-mode-8.17.1.tar.gz"
  sha256 "659b159f5a27147e0a1f9ec6bafc1bd7ac4f9a8adcfa1330b770787f489a0e9a"
  license "BUSL-1.1"
