class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.32.0/loki-mode-9.32.0.tar.gz"
  sha256 "fc36f503b4bbfc99ea74531f59196d8f4f9cb0d0f1acb2aea6069e56eb8cbcd8"
  license "BUSL-1.1"
