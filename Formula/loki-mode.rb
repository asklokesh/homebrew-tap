class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.115.0/loki-mode-7.115.0.tar.gz"
  sha256 "04a47cbb178d98a9bb1e9b9d5113699673dbe5cc6079850397aa2be98dca211b"
  license "BUSL-1.1"
