class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.42.0/loki-mode-7.42.0.tar.gz"
  sha256 "2ccbfe456524ac143ffa06c232898a75dc9fb2cf451d576287261c15ded6d8e5"
  license "BUSL-1.1"
