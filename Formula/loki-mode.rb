class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.64.0/loki-mode-7.64.0.tar.gz"
  sha256 "ec2072db7fe068442d3d79bc924b8c50744568ef2398915cc9384ee7e3a7d3fa"
  license "BUSL-1.1"
