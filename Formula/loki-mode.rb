class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.52.0/loki-mode-7.52.0.tar.gz"
  sha256 "a43704ea19cb21f9b115b8cea28034d1a9a5c4a8e22767ba1cd5e06a73914ae1"
  license "BUSL-1.1"
