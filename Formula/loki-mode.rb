class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.50.4/loki-mode-9.50.4.tar.gz"
  sha256 "7e326e9e5a8d8a7529ecc1d18b12f0d20b3e9b6d8dc37c0799fd9968f9fc8c18"
  license "BUSL-1.1"
