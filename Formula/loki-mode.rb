class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.85.0/loki-mode-8.85.0.tar.gz"
  sha256 "ef2d58142ad980949ad04506b4b605176d3d2a43cc9a96a50d9cd65a8605a93e"
  license "BUSL-1.1"
