class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.46.0/loki-mode-8.46.0.tar.gz"
  sha256 "530e0961a3c6e0ad2e8dbdd3482cbcd74159f624c8d53015a6f3ef38f66c3ac6"
  license "BUSL-1.1"
