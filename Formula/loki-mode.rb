class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.77.0/loki-mode-7.77.0.tar.gz"
  sha256 "84a76cf0f7681365a2fc52a34da88e32e4d5d9a323d1a14db8ce122b1f6edf72"
  license "BUSL-1.1"
