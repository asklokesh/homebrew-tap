class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.75.0/loki-mode-8.75.0.tar.gz"
  sha256 "d21cfee738a3830f00686cf4a8de8f96c81fe7f1ed5b682c9980f9060ab90c4a"
  license "BUSL-1.1"
