class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.82.0/loki-mode-8.82.0.tar.gz"
  sha256 "31b978573728aa91afab4f1eebec9d7b1ba1f49bafc8ee70650cfef8524cd004"
  license "BUSL-1.1"
