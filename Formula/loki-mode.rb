class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.28.0/loki-mode-8.28.0.tar.gz"
  sha256 "c567802cc8cc288821727aa300c9a0cacc2f5bbd9d1db1656577950c229c87bc"
  license "BUSL-1.1"
