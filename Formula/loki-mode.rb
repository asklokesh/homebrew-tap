class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.17.2/loki-mode-8.17.2.tar.gz"
  sha256 "f1d1f8f42c20a45b51cf6e455d1846e071c84ae02614989990f23c7855332f76"
  license "BUSL-1.1"
