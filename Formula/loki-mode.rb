class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.0.1/loki-mode-8.0.1.tar.gz"
  sha256 "ac7262875443db6ec5f5ca21d8ff223b0c1e1dd3563edf5131186a4164732fe5"
  license "BUSL-1.1"
