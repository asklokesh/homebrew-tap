class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.41.3/loki-mode-7.41.3.tar.gz"
  sha256 "ab3767bf12dbc742565e68884144b4dc8f66be6a90318bed8e78ffd5cb8adc72"
  license "BUSL-1.1"
