class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.46.0/loki-mode-7.46.0.tar.gz"
  sha256 "acb74d0d85a04728aeec00c5019a62409fffdc7f64a3e0faadc6acccc5be9a13"
  license "BUSL-1.1"
