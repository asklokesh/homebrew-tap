class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.16.3/loki-mode-8.16.3.tar.gz"
  sha256 "e8802f3751b3fb378601ef447edb89331d0c8a5e01802aaeee5f8b21500aaad4"
  license "BUSL-1.1"
