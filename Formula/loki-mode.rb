class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.23.1/loki-mode-8.23.1.tar.gz"
  sha256 "bab32ff1698dba2e55836f6081d6662c49c17e1d07ea8b31f6fbe5ade6bc17d7"
  license "BUSL-1.1"
