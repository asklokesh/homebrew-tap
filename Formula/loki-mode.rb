class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.44.0/loki-mode-7.44.0.tar.gz"
  sha256 "f9a5e5e90736bd132851b4bea39d7bdfb70a7b2d0339cd319d7d589109cb7b3a"
  license "BUSL-1.1"
