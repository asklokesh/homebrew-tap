class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.99.1/loki-mode-7.99.1.tar.gz"
  sha256 "ff96f6bfcfa58c65f036c8062e88f356a8732a830685fbb6a2b0e9fab9b4c3e6"
  license "BUSL-1.1"
