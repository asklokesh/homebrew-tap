class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.121.0/loki-mode-7.121.0.tar.gz"
  sha256 "59f93f32b7f9467c4266e476fb22f93624cf4e6805ece2d0a491127781405ae2"
  license "BUSL-1.1"
