class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.22.0/loki-mode-9.22.0.tar.gz"
  sha256 "ba46b301a9e65f9ae0006be986d6468f66cf5a8ea53c0294499cb35250a64bc0"
  license "BUSL-1.1"
