class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.19.1/loki-mode-9.19.1.tar.gz"
  sha256 "5396610cbb61b1a7406513f3e13a79935a39ff68111731e14c0efe3ebdbc074e"
  license "BUSL-1.1"
