class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.67.0/loki-mode-8.67.0.tar.gz"
  sha256 "b5edb9543cdc788b302a1eab6f66aeb124775ae6e05b4366d5ec3146931a0cd3"
  license "BUSL-1.1"
