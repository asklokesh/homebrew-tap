class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.22.5/loki-mode-9.22.5.tar.gz"
  sha256 "a72942fb2848241493e2b8bd81ca6ab0c4ca49a9b6fd609af218514b246c2b28"
  license "BUSL-1.1"
