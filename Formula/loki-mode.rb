class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.6.0/loki-mode-8.6.0.tar.gz"
  sha256 "5e9d2ac69bb15622c698810be902477b32507d2e30a05ea52eb6e52c59690b4d"
  license "BUSL-1.1"
