class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.0.2/loki-mode-8.0.2.tar.gz"
  sha256 "539f80e5f5b77a57633371de25d4bc3763eb92a45136777a0db080e2d7ae4ea8"
  license "BUSL-1.1"
