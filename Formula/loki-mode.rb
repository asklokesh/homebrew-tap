class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.14.1/loki-mode-8.14.1.tar.gz"
  sha256 "b98d0e1c8cb3e8416463d7e78351e990c8fafd73d2c35d99629d033d5fe1b9c5"
  license "BUSL-1.1"
