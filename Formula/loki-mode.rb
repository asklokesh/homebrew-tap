class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.90.0/loki-mode-8.90.0.tar.gz"
  sha256 "e18699289731f375159edb776e19206ae087b852feb6ea55b71b1c765aad96b6"
  license "BUSL-1.1"
