class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.27.3/loki-mode-9.27.3.tar.gz"
  sha256 "0b26565e0ec3487d7a57a15a983afcc41b9083a9b4029db5f3db5f19a28902cf"
  license "BUSL-1.1"
