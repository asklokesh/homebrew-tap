class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.63.0/loki-mode-8.63.0.tar.gz"
  sha256 "d9d17253f064288eec6bf5a9c2f75d6aae9388a2a1f96001e8f0df6250fd674f"
  license "BUSL-1.1"
