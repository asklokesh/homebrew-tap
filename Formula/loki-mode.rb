class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.50.2/loki-mode-9.50.2.tar.gz"
  sha256 "3a2cf2c1015e0e7a6b2e86264ff3961ac6951c33a8324fb80d8ff517047ccf0b"
  license "BUSL-1.1"
