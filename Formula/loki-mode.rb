class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.128.0/loki-mode-7.128.0.tar.gz"
  sha256 "fbd399e4b567636701bf45ecf6669f3075ce933cf058ed129b4a0a7803ec3d63"
  license "BUSL-1.1"
