class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.70.0/loki-mode-7.70.0.tar.gz"
  sha256 "8b3810045e6f6bf8972a6205d2343b4453316fe2aa3a061fc04ab4b223687e5e"
  license "BUSL-1.1"
