class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.79.0/loki-mode-8.79.0.tar.gz"
  sha256 "50f72b7f8d0cb0f2ee7241b7673ed7988a01bbc440a2421a30153606619f92af"
  license "BUSL-1.1"
