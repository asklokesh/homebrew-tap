class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v7.103.0/loki-mode-7.103.0.tar.gz"
  sha256 "630d45531156c8ddcaa09e994dc47386663118923b2d2e983c0ea3bab6d6b582"
  license "BUSL-1.1"
