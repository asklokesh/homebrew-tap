class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.39.0/loki-mode-8.39.0.tar.gz"
  sha256 "f9bed04d679307d5fa1d7c638d9ef56a189f1010fe2922e298570ac43db20d7d"
  license "BUSL-1.1"
