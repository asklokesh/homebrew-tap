class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.24.0/loki-mode-8.24.0.tar.gz"
  sha256 "adfabc27ff23c2e57ba79cbba04d7d5e5dfd0e83225fd5bf047cfbcafa23229e"
  license "BUSL-1.1"
