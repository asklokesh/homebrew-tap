class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.22.1/loki-mode-8.22.1.tar.gz"
  sha256 "0b377e6123909d32a6010db39a3dffda2bd6cc9fc8270ddf3cf67fd6254f5e5f"
  license "BUSL-1.1"
