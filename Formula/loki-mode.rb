class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.36.0/loki-mode-8.36.0.tar.gz"
  sha256 "4682b664e2a9f2b223f6f4417417d5edae62637f713c801312463d2e92c7582b"
  license "BUSL-1.1"
