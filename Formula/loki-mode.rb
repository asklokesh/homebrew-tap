class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.89.0/loki-mode-8.89.0.tar.gz"
  sha256 "9e3f7e9d4f7bf6abf2fee9baabd348f5df821f7ce95a1689b38fb02bcc32bead"
  license "BUSL-1.1"
