class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.8.1/loki-mode-8.8.1.tar.gz"
  sha256 "8e0e83b8f9c3bb3a9177d30b14a72b72eb814c6f0db035ab9b46d8ae7306ea10"
  license "BUSL-1.1"
