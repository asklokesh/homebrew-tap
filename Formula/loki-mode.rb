class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v8.99.0/loki-mode-8.99.0.tar.gz"
  sha256 "e6748231bfc30f33e2ccc979322f3aea7da63ec8ad293dd0b10beda9571fe142"
  license "BUSL-1.1"
