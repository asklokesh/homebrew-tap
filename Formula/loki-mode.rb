class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.36.0/loki-mode-9.36.0.tar.gz"
  sha256 "4d8bde36ca0c7dc4cfdd02a7b6ce61014a6ae8d9129c82a383f6421ea2e9e2e0"
  license "BUSL-1.1"
