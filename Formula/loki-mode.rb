class LokiMode < Formula
  ...
  url "https://github.com/asklokesh/loki-mode/releases/download/v9.22.11/loki-mode-9.22.11.tar.gz"
  sha256 "6479c57c1cc77d4b0f67b40603d73cbc49814546178e27fd6a0326ae85198abb"
  license "BUSL-1.1"
